  ...
  <div class="card p-4 shadow">
    ...
    <form action="{{ route('patient.detection.store') }}" method="POST">
      ...
      <div class="row">
        ...
        <div class="col-md-6 mb-3"><label>Diabetes Pedigree Function</label><input type="number" step="0.01" name="diabetes_pedigree_function" class="form-control" required>
